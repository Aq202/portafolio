...
export default [
  ...
  },
  {
    ...
    images: [img1P2, img2P2, img3P2, img4P2, img5P2],
  },
  {
    title: 'Memoria de películas',
    description:
      'Este proyecto consiste en el clásico juego de memoria, con una temática de mis películas y series favoritas. El juego permite establecer la cantidad de parejas con las cuales se va a jugar, registra la cantidad de movimientos efectuados y muestra un mensaje de felicitaciones cuando se encuentran todas las parejas.',
    images: [img1P3, img2P3, img3P3],
    link: 'https://uvgenios.online/21762/lab06/',
  },
  {
  ...
  },
  {
    ...
    description: 'Este proyecto cuenta con todas las funcionalidades de una calculadora sencilla, implementadas con tecnologías web.',
    images: [img1P6],
    link: 'https://uvgenios.online/21762/lab09',
  },
];
